...
<body>
<nav class="navbar navbar" style="border-radius:1px;">
  <div class="container-fluid">
    <body style='background-color: ;'>
    
    <div class="navbar-header">
      <button type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#bs-example-navbar-collapse-1" aria-expanded="false" style="background: blue;">
        ...
        <div class="container">
            ...
            <div class=" ">
                ...
                <ul class="nav navbar-nav navbar-right">
                   ...
                   <li class="nav-item"><a class="nav-link" href="#tm-section-4">About</a></li>
                   <li class="nav-item"><a class="nav-link" href="#tm-section-2">Brgy Officials</a> </li> 
...
<div class="container" style="padding-top: 15rem;"><br><br><br>
  <center><img src="../img/home_img01.jpg" style="width:1200px; height: 500px;"></center>
</div>
<br>
<br>
        ...
        <div class="container">
          <div class="row">
            <div class="col-xs-12 mx-auto tm-about-text-wrap text-center">                        
              <h2 class="text-uppercase mb-4" style="padding-top: 5rem">Welcome to <strong>Barangay Looc</strong> !</h2>
